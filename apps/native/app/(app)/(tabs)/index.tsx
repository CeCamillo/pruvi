  ...
  return (
    <Svg width={28} height={28} viewBox="0 0 28 28" fill="none">
      <Path
        ...
        fillOpacity={0.3}
      />
      <Path d="M4 7a2 2 0 012-2h16a2 2 0 012 2v2H4V7z" fill="#D08700" />
...
function TopBar({
  ...
  // Show XP as a compact number (2.4k for 2400+).
  const xpLabel =
    totalXp == null
      ? "--"
      : totalXp >= 1000
      ...
      <View style={styles.topBarContent}>
        ...
        <View style={styles.topBarRight}>
          <View style={styles.badgeOrange}>
            <FireIcon size={16} />
            <Text style={styles.badgeOrangeText}>{streak ?? 0}</Text>
          </View>
          <View style={styles.badgeGreen}>
            <LeafIcon size={16} />
            <Text style={styles.badgeGreenText}>{xpLabel}</Text>
          </View>
        </View>
      </View>
    </View>
    ...
    <View style={styles.heroCard}>
      ...
      <View style={styles.heroContent}>
        <View style={styles.heroTextArea}>
          <Text style={styles.heroGreeting}>E aí, {userName}! </Text>
...
function WeeklyActivityCard() {
  // Placeholder until Phase 6+ wires real daily-minute data.
  const WEEK_DAYS = [
    { label: "S", height: 32, opacity: 0.2, active: false },
    { label: "T", height: 54, opacity: 0.2, active: false },
    { label: "Q", height: 80, opacity: 0.4, active: false },
    { label: "Q", height: 107, opacity: 1, active: true },
    { label: "S", height: 11, opacity: 0.1, active: false },
    { label: "S", height: 0, opacity: 0, active: false },
    { label: "D", height: 0, opacity: 0, active: false },
  ];
  return (
...
export default function Home() {
  ...
  const noLives = lives.data?.lives === 0;
  const buttonPending = startSession.isPending;

  const userName = session?.user?.name?.split(" ")[0] ?? "estudante";

  // CTA text follows the session state so the hero always reflects
  // what tapping the button will actually do.
      ...
      >
        <View style={styles.section}>
          <HeroCard
            ...
            onPress={handlePress}
            disabled={isCompleted || noLives || buttonPending}
          />
        </View>
